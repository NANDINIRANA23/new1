...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig=px.pie(filtered_df,names='pie chart names',title='success vs failed for selected launch site')
        return fig,                        

                                html.P("Payload range (Kg):"),
                                # TASK 3: Add a slider to select payload range
                                dcc.RangeSlider(id='payload-slider',min=0,max=1000,step=1000,
                                marks={0:'0',100:'100'},
...
def get_scatter_point(selected_site, payload_range):
